// * For iterative, use n as a power of 2 for perfect single binary tree, otherwise family of trees
	// * The dynamic setting uses hashtables for iterative (not 100% efficient), but for true dynamic, use the pointer version towards bottom
...
// Credit: https://github.com/FlowerOfSorrow
