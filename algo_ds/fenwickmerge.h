...
//good for existence queries and bound queries on subarrays (log^2 n) if updates!

//not good for HLD! bc log^3 times out... see wavelet for better if no need for updates
