...
const int _ = 1005, MOD = 1e9 + 7, xd[] = {0,1,0,-1}, yd[] = {1,0,-1,0}, INF = 0x3f3f3f3f;
const ll INFLL = 0x3f3f3f3f3f3f3f3f;

int h,w,dp[_][_]; char g[_][_];

int main() { 
	IO("");	
	re(h,w); 
	F0R(i,h) F0R(j,w) re(g[i][j]);
	dp[0][0] = 1;
	F0R(i,h) F0R(j,w) {
		if(i + 1 < h && g[i+1][j] == '.') (dp[i+1][j] += dp[i][j]) %= MOD; 
		if(j + 1 < w && g[i][j+1] == '.') (dp[i][j+1] += dp[i][j]) %= MOD;
	}
	pr(dp[h-1][w-1]);
}
